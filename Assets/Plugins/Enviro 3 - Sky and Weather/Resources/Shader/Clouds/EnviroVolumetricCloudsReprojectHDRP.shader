    	...
    	Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                {	 
                    ...
                    float originalPointDepth = LinearEyeDepth(LOAD_TEXTURE2D(_DownsampledDepth, i.uv * _DepthHandleScale.zw * _DepthHandleScale.xy), _ZBufferParams);
                    ...
                    for (int x = -1; x <= 1; x ++) 
                    {
                        ...
                        for (int y = -1; y <= 1; y ++ ) 
                        {
                            ...
                            else 
                            {
                                ...
                                float depth = LinearEyeDepth(LOAD_TEXTURE2D(_DownsampledDepth,uv * _DepthHandleScale.zw * _DepthHandleScale.xy), _ZBufferParams);
