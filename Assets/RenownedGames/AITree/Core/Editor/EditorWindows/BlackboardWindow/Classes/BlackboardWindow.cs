...
#pragma warning restore CS0618 // Key Details window is obsolete
        ...
        private void OnUndoRedo()
        {
            EditorApplication.delayCall += () =>
            {
                ...
                {
                    string path = AssetDatabase.GetAssetPath(blackboard);
...
#pragma warning restore CS0618 // Key Details window is obsolete
            {
                if (keyboardEvent.keyCode == KeyCode.Delete || (keyboardEvent.control && keyboardEvent.keyCode == KeyCode.Backspace))
                {
