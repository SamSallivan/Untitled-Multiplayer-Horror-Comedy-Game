...
namespace RenownedGames.AITreeEditor
{
    public class BehaviourTreeGraph : GraphView
    {
        ...
        private void HotKeyListener()
        {
            ...
            {
                if ((evt.type == EventType.KeyDown && evt.keyCode == KeyCode.Backspace && evt.control)
                    || (evt.type == EventType.KeyDown && evt.keyCode == KeyCode.Backspace && evt.command)
                    || (evt.type == EventType.KeyDown && evt.keyCode == KeyCode.Delete && evt.control)
                    || (evt.type == EventType.KeyDown && evt.keyCode == KeyCode.Delete && evt.command)
                    || (evt.type == EventType.KeyDown && evt.keyCode == KeyCode.Delete)
                    || (evt.type == EventType.Used && evt.keyCode == KeyCode.Delete))
                {
                    DeleteSelectionCallback(AskUser.DontAskUser);
                }
                else if ((evt.type == EventType.Used && evt.keyCode == KeyCode.C)
                    || (evt.type == EventType.KeyDown && evt.keyCode == KeyCode.C))
                {
                    CopySelectionCallback();
                }
                else if ((evt.type == EventType.Used && evt.keyCode == KeyCode.V)
                    || (evt.type == EventType.KeyDown && evt.keyCode == KeyCode.V))
                {
                    PasteCallback();
                }
                else if((evt.type == EventType.Used && evt.keyCode == KeyCode.D)
                    || (evt.type == EventType.KeyDown && evt.keyCode == KeyCode.D))
                {
